...
class CrosswordCreator():
    ...
    def ac3(self, arcs=None):
        ...
        for i, j in arcs:
            if self.revise(i, j):
                for neighbor in self.crossword.neighbors(i):
                    arcs.append((i, neighbor))

        return len(self.domains[i]) > 0
        ...
        for var1 in assignment:
            ...
            for var2 in assignment:
                ...
                if var1 != var2:
                    ...
                    # same word assigned to different variables
                    if word1 == word2:
                        return False
                    ...
                    if overlap:
                        ...
                        # check if the overlapping index has same value
                        if word1[i] != word2[j]:
                            return False
        return True
    ...
    def backtrack(self, assignment):
        ...
        for variable in self.order_domain_values(unassigned_var, assignment):
            new_assignment = assignment.copy()
            new_assignment[unassigned_var] = variable
            if self.consistent(new_assignment):
                ans = self.backtrack(new_assignment)
                if ans:
                    return ans
        return None
